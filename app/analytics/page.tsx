...
export default function AnalyticsPage() {
  ...
  return (
    <div className="p-8 max-w-5xl">
      ...
      {/* Ask Jarvis — conversational GA4 interface */}
      <AskJarvis context="ga4" placeholder="e.g. How did my site do yesterday? Which page gets most traffic?" />
    </div>
  )
}

const QUICK_QUESTIONS_GA4 = [
  "How did my site do yesterday?",
  "Which page gets the most traffic?",
  "Are people reading my blog or bouncing?",
  "What time of day do visitors usually come?",
]

function AskJarvis({ context, placeholder }: { context: string; placeholder: string }) {
  ...
  return (
    <div className="bg-[#1C1C1C] border border-white/[0.07] rounded-xl p-6 mt-6">
      ...
      <div className="text-[12px] text-[#475569] mb-4">Ask a plain English question about your data</div>
