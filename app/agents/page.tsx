...
export default function AgentsPage() {
  ...
  return (
    <div className="p-8 max-w-7xl">
      ...
      {/* Edit note */}
      <div className="mb-4 bg-[#14B8A6]/05 border border-[#14B8A6]/20 rounded-xl px-4 py-3 flex items-center justify-between">
        <span className="text-[12px] text-[#64748B]">View-only graph. To edit agent configs, schedules, or skills →</span>
        <a href="/agent-skills" className="text-[12px] font-semibold text-[#14B8A6] hover:underline shrink-0 ml-3">Agent Skills ↗</a>
      </div>
