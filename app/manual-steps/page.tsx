...
const ALL_STEPS: Step[] = [
  ...
  // ── HIGH PRIORITY ─────────────────────────────────────────────────────────
  {
    id: "anthropic_key",
    priority: "high",
    title: "Add ANTHROPIC_API_KEY to Vercel + GitHub Secrets",
    text: "AI Chat falls back to Gemini without this. Also missing from GitHub secrets so agents can't use Claude fallback.",
    link: "https://console.anthropic.com/settings/keys",
    link_label: "Get Anthropic Key",
    blocks_what: "Claude AI Chat on dashboard + Claude fallback in agents",
    steps: [
      ...
      "Redeploy Vercel or wait for auto-deploy",
    ],
    done: false,
  },
  {
