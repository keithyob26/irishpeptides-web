...
const ALL_STEPS: Step[] = [
  ...
  },
  {
    id: "tiktok_reenable",
    priority: "critical",
    title: "Re-enable TikTok Posting After Suspension",
    text: "TikTok suspended 24hrs (peptide content flagging). Rename account + flip code flag after suspension lifts ~10am Jun 19.",
    link: "https://www.tiktok.com/",
    link_label: "Open TikTok",
    blocks_what: "TikTok automated posting via Buffer",
    steps: [
      "Confirm suspension lifted — check TikTok app, no restriction banner",
      "Rename username to @keithobeirne_nutrition (Settings → Account → Username)",
      "Add profile photo + bio: 'Peptide research & performance nutrition | Educational content only | Not medical advice'",
      "In agents/content_engine.py — set TIKTOK_POSTING_ENABLED = True (line ~10)",
      "In agents/first_social_post.py — set TIKTOK_POSTING_ENABLED = True (line ~26)",
      "Git commit + push: git commit -am 'feat: re-enable TikTok posting' && git push",
    ],
    done: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      "Go to firefly-iii.org and sign up for Firefly III hosted cloud (no Docker needed)",
      "Or self-host on a VPS: Ubuntu + nginx + Docker (not on work laptop)",
      "Monthly expense tracking: create accounts for business vs personal",
      "Connect bank CSV export or manual entry",
    ],
    done: false,
  },
];
