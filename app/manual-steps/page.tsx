...
const ALL_STEPS: Step[] = [
  ...
  // ── HIGH PRIORITY ─────────────────────────────────────────────────────────
  {
    id: "anthropic_key",
    priority: "high",
    title: "Add ANTHROPIC_API_KEY to Vercel",
    text: "AI Chat falls back to Gemini without this. Claude is primary model.",
    link: "https://console.anthropic.com/settings/keys",
    link_label: "Get Anthropic Key",
    blocks_what: "Claude-powered AI Chat on dashboard",
    steps: [
      "Go to console.anthropic.com → Settings → API Keys",
      "Create new key → name: IrishPeptides Vercel",
      "Copy the key (sk-ant-...)",
      "Go to vercel.com → irishpeptides-web project → Settings → Environment Variables",
      "Add: ANTHROPIC_API_KEY = <paste key>",
  ...
  },
  {
    id: "ga4_json",
    priority: "high",
    title: "Add GA4 Service Account JSON to Vercel",
    text: "Analytics panel shows no data without this.",
    link: "https://console.cloud.google.com/iam-admin/serviceaccounts",
    link_label: "Google Cloud Console",
    blocks_what: "Analytics panel real data",
    steps: [
      "Go to console.cloud.google.com → IAM → Service Accounts",
      "Find or create service account for irishpeptides",
      "Keys tab → Add Key → JSON → download file",
      "Go to vercel.com → irishpeptides-web → Settings → Env Vars",
      "Add: GA4_SERVICE_ACCOUNT_JSON = <paste full JSON content>",
      "Redeploy",
    ],
    done: false,
  },
